...
# Debug prints for environment and paths
print(f"[ENV] APP_ENV={APP_ENV}")
print(f"[PATH] BASE_INDEX_DIR={BASE_INDEX_DIR}")
print(f"[LOOKUP] LISTA_TXT={LISTA_TXT}")
print(f"[LOOKUP] INDEX_FAISS={INDEX_FAISS}")
